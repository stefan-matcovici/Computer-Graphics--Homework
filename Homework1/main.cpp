...
void Display8() {
	...
	glBegin(GL_POLYGON);
	for (int i = 0; i < 6; ++i) {
		glVertex2d(sin(i / 6.0 * 2 * M_PI + M_PI / 2.0)*0.75,
			cos(i / 6.0 * 2 * M_PI + M_PI / 2.0)*0.75);
	}
	glEnd();
	...
	glBegin(GL_POLYGON);
	for (int i = 0; i < 6; ++i) {
		glVertex2d(sin(i / 6.0 * 2.0 * M_PI + M_PI / 2.0)*0.52,
			cos(i / 6.0 * 2 * M_PI + M_PI / 2.0)*0.52);
	}
	glEnd();
	...
	glBegin(GL_POLYGON);
	for (int i = 0; i < 6; ++i) {
		glVertex2d(sin(i / 6.0 * 2.0 * M_PI + M_PI / 2.0)*0.5,
			cos(i / 6.0 * 2.0 * M_PI + M_PI / 2.0)*0.5);
	}
	glEnd();
	...
	glBegin(GL_POLYGON);
	for (int i = 5; i >=0; --i) {
		glVertex2d(cos(i / 6.0 * 2.0 * M_PI)*0.75,
			sin(i / 6.0 * 2 * M_PI)*0.75);
	}
	glEnd();
	...
	glBegin(GL_POLYGON);
	for (int i = 5; i >= 0; --i) {
		glVertex2d(cos(i / 6.0 * 2.0 * M_PI)*0.52,
			sin(i / 6.0 * 2 * M_PI)*0.52);
	}
	glEnd();
	...
	glBegin(GL_POLYGON);
	for (int i = 5; i >= 0; --i) {
		glVertex2d(cos(i / 6.0 * 2.0 * M_PI)*0.5,
			sin(i / 6.0 * 2 * M_PI)*0.5);
	}
	glEnd();*/
}
